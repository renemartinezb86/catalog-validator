...
import { INDComponent } from 'app/entities/ind/ind.component';
import { INDService } from 'app/entities/ind/ind.service';
import { IND } from 'app/shared/model/ind.model';

describe('Component Tests', () => {
    describe('IND Management Component', () => {
        let comp: INDComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.iNDS[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
