...
import { SimpleItemComponent } from 'app/entities/simple-item/simple-item.component';
...
describe('Component Tests', () => {
    describe('SimpleItem Management Component', () => {
        let comp: SimpleItemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SimpleItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.simpleItems[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
