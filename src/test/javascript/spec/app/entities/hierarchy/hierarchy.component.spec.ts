...
import { HierarchyComponent } from 'app/entities/hierarchy/hierarchy.component';
...
describe('Component Tests', () => {
    describe('Hierarchy Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.hierarchies[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
