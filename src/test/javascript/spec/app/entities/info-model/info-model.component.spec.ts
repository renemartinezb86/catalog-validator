...
import { InfoModelComponent } from 'app/entities/info-model/info-model.component';
...
describe('Component Tests', () => {
    describe('InfoModel Management Component', () => {
        let comp: InfoModelComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InfoModelComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.infoModels[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
