...
import { BaseItemComponent } from 'app/entities/base-item/base-item.component';
...
describe('Component Tests', () => {
    describe('BaseItem Management Component', () => {
        let comp: BaseItemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BaseItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.baseItems[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
